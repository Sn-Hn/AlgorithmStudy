...
public class 스타트택시_19238 {
	...
	public static void main(String[] args) throws IOException {
		...
		for (Pair p : departurePosition) {
			System.out.println(
					"p.x : " + p.x + ", p.y : " + p.y + ", p.distance : " + p.distance + ", p.index : " + p.index);
		}
...
//                    System.out.println(index);
					...
					if (arrive(X, Y, arrivalIndex)) {
						System.out.println(
								departurePosition.get(departureIndex).x + "," + departurePosition.get(departureIndex).y
										+ "," + departurePosition.get(departureIndex).distance + ","
										+ departurePosition.get(departureIndex).index);
						System.out.println(arrivalPosition.get(arrivalIndex).x + ","
								+ arrivalPosition.get(arrivalIndex).y + "," + arrivalPosition.get(arrivalIndex).distance
								+ "," + arrivalPosition.get(arrivalIndex).index);
